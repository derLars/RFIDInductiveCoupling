...
\noindent Nach Ablauf eines \(\tau \) erreicht der Strom \(I_l\) in der Spule etwa 63\% des Gesamtstroms und nach \(5\tau \) erreicht dieser 99,3\%. Ab diesem Zeitpunkt wird der Einschaltvorgang in der Regel als abgeschlossen angesehen\footnote{Stiny: Grundwissen Elektrotechnik, S. 147 f.}. Visuell dargestellt ergibt sich für den Einschaltvorgang einer Spule ein Diagramm nach folgendem Beispiel.
...
\subsection{Reihenresonanzkreis}\label{sec:serialresonancecircuit}
{\noindent 
\begin{wrapfigure}{r}{0.5\textwidth}
    \begin{minipage}[r]{0.5\textwidth}
      \vspace{-16pt}
